...
resource "random_id" "Dev-create_user-randomID" {
  byte_length = 8
}

resource "google_storage_bucket" "Dev-create_user-bucket" {
  name                        = "${random_id.Dev-create_user-randomID.hex}-gcf-source"
  location                    = "US"
...
resource "google_cloudfunctions_function" "cf_Dev_create_user" {
  name        = "cf_Dev-create_user"
  runtime     = "python39"

  source_archive_bucket = google_storage_bucket.Dev-create_user-bucket.name
  source_archive_object = google_storage_bucket_object.Dev-create_user-object.name
...
resource "random_id" "Dev-get_user-randomID" {
  byte_length = 8
}

resource "google_storage_bucket" "Dev-get_user-bucket" {
  name                        = "${random_id.Dev-get_user-randomID.hex}-gcf-source"
  location                    = "US"
  uniform_bucket_level_access = true
}
...
resource "google_cloudfunctions_function" "cf_Dev_get_user" {
  name        = "cf_Dev-get_user"
  runtime     = "python39"

  source_archive_bucket = google_storage_bucket.Dev-get_user-bucket.name
  source_archive_object = google_storage_bucket_object.Dev-get_user-object.name
  available_memory_mb = "256"
  timeout = 60
  max_instances = 1
  trigger_http = true
...
resource "random_id" "Dev-update_user-randomID" {
  byte_length = 8
}

resource "google_storage_bucket" "Dev-update_user-bucket" {
  name                        = "${random_id.Dev-update_user-randomID.hex}-gcf-source"
  location                    = "US"
  uniform_bucket_level_access = true
}
...
resource "google_cloudfunctions_function" "cf_Dev_update_user" {
  name        = "cf_Dev-update_user"
  runtime     = "python39"

  source_archive_bucket = google_storage_bucket.Dev-update_user-bucket.name
  source_archive_object = google_storage_bucket_object.Dev-update_user-object.name
  available_memory_mb = "256"
  timeout = 60
  max_instances = 1
  trigger_http = true
...
resource "random_id" "Dev-delete_user-randomID" {
  byte_length = 8
}

resource "google_storage_bucket" "Dev-delete_user-bucket" {
  name                        = "${random_id.Dev-delete_user-randomID.hex}-gcf-source"
  location                    = "US"
  uniform_bucket_level_access = true
}
...
resource "google_cloudfunctions_function" "cf_Dev_delete_user" {
  name        = "cf_Dev-delete_user"
  runtime     = "python39"

  source_archive_bucket = google_storage_bucket.Dev-delete_user-bucket.name
  source_archive_object = google_storage_bucket_object.Dev-delete_user-object.name
  available_memory_mb = "256"
  timeout = 60
  max_instances = 1
  trigger_http = true
