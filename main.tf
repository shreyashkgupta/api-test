...
resource "aws_dynamodb_table" "Chatbot_trial-dev-chatbot_data" {
  name           = "Chatbot_trial-dev-chatbot_data"
  billing_mode   = "PROVISIONED"
  read_capacity  = 20
  write_capacity = 20
  hash_key       = "chatbot_dataId"
...
function_name                  = "Chatbot_trial-dev-list_chatbots"
...
resource "aws_api_gateway_resource" "proxy_Chatbot_trial_list_chatbots" {
  rest_api_id = "${aws_api_gateway_rest_api.api_gateway_dev_Chatbot_trial.id}"
  parent_id   = "${aws_api_gateway_rest_api.api_gateway_dev_Chatbot_trial.root_resource_id}"
  path_part   = "list_chatbots"
}

resource "aws_api_gateway_method" "proxy_dev_Chatbot_trial_list_chatbots" {
  rest_api_id   = "${aws_api_gateway_rest_api.api_gateway_dev_Chatbot_trial.id}"
  resource_id   = "${aws_api_gateway_resource.proxy_Chatbot_trial_list_chatbots.id}"
  http_method   = "GET"
  authorization = "NONE"
}

resource "aws_api_gateway_integration" "lambda_dev_Chatbot_trial_list_chatbots" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway_dev_Chatbot_trial.id
  resource_id = aws_api_gateway_method.proxy_dev_Chatbot_trial_list_chatbots.resource_id
  http_method = aws_api_gateway_method.proxy_dev_Chatbot_trial_list_chatbots.http_method
...
resource "aws_api_gateway_deployment" "api_gateway_dev_Chatbot_trial" {
  ...
  aws_api_gateway_method.proxy_dev_Chatbot_trial_list_chatbots.resource_id,
  aws_api_gateway_method.proxy_dev_Chatbot_trial_list_chatbots.id,
  aws_api_gateway_integration.lambda_dev_Chatbot_trial_list_chatbots.id,
